...
Shiv Shakti Public School - School Management System
"""
...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-(5w%d1g^st1z2^#ov6dzmmu%qdq63o-#x#)z0ly&g^_5afp@-u'
)
...
# Database
# Uses DATABASE_URL env variable on Railway (PostgreSQL)
