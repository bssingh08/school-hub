...
class SchoolInfo(models.Model):
    ...
    school_name = models.CharField(max_length=200, default='Shiv Shakti Public School')
    address = models.TextField(default='Near Nagwati Asthan Kali Mandir, Barhiya')
    contact_number = models.CharField(max_length=15, default='9973605904')
    contact_number_2 = models.CharField(max_length=15, default='8544240801', blank=True)
    email = models.EmailField(default='shivshaktipublicschool123@gmail.com')
    principal_name = models.CharField(max_length=100, default='Pawan Kumar')
